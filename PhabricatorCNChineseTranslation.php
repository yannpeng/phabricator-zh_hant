...
If you specify an invalid rsvp, the command is ignored. This command has no effect if you do not specify an rsvp.' => NULL,
  ...
  'Type a user or project name, or function...' => '请输入使用者或项目名称或函数',
  'URI to import.' => NULL,
...
Reason: %s' => NULL,
  ...
  'Display project reviewers.' => '显示项目审查员。',
...
提交规则可以用来发送邮件、标记提交、触发审查以及执行建置计划。',
  ...
  'Select repositories tagged with this project.' => '选择标记此项目的档桉库。',
  'Set Credential' => '设定凭证',
...
The keys in this map are viewable MIME types; the values are the MIME types they are delivered as when they are viewed in the browser.' => NULL,
 ...
 %s' => NULL,
  ...
  'If you\'re new to Phabricator, these optional steps can help you learn the basics. Conceptually, Phabricator is structured as a graph, and repositories, tasks, and projects are all independent from each other. Feel free to set up Phabricator for how you work best, and explore these features at your own pace.' => '若您是第一次接触 Phabricator，以下这些选择性设定的步骤可以协助您了解一些基础，概念上 Phabricator 的结构就像一张由档桉库、工作与项目所组成且彼此之间完全独立的图，可以随意设定 Phabricator 来让您作业达到最佳状况，然后再随着您的步调慢慢探索这些功能。',
  ...
  'Project tags define everything. Create them for teams, tags, or actual projects.' => '项目标籤可以用来定义任何事物。建立供团队、标籤或实际项目的项目标籤。',
  'Quick Start' => '快速入门',
  ...
  'You\'ve created at least one project.' => '您已建立了至少一个项目。',
...
You can choose which priority is the default for newly created tasks with `%s`.' => NULL,
  ...
  'Can Edit Task Projects' => '可编辑工作项目',
  ...
  'Changed Project Column' => '已更改项目栏位',
  ...
  'Maniphest Project Name Cache' => '问题管理 项目名称快取',
...
This setting allows for "locking" these policies such that no further edits can be made on a per-policy basis.' => NULL,
  ...
  '%s added %s project(s) for %s: %s.' => '%s 加入了 %s 个项目于 %s: %s。',
  ...
  '%s changed project hashtag(s), added %d: %s; removed %d: %s.' => '%s 更改了项目 Hashtag，加入了 %d: %s; 移除了 %d: %s。',
  '%s changed project member(s), added %d: %s; removed %d: %s.' => '%s 更改了项目成员，加入了 %d: %s; 移除了 %d: %s。',
  '%s changed the background color of the project workboard.' => '%s 更改了项目工作看板的背景色彩。',
  '%s changed the default filter for the project workboard.' => '%s 更改了项目工作看板的预设筛选。',
  '%s changed the default sort order for the project workboard.' => '%s 更改了项目工作看板的预设排列顺序。',
  '%s created this column.' => '%s 建立了这个栏。',
  '%s created this project.' => '%s 建立了这个项目。',
  '%s disabled the workboard for this project.' => '%s 关闭了这个项目的工作看板。',
  '%s edited %s project(s) for %s, added %s: %s; removed %s: %s.' => NULL,
  '%s edited %s project(s), added %s: %s; removed %s: %s.' => '%s 编辑了 %s 项目，加入了 %s: %s; 移除了 %s: %s。',
  ...
  '%s removed %d project hashtag(s): %s.' => '%s 移除了 %d 个项目 Hashtag: %s。',
  ...
  '%s renamed this project from "%s" to "%s".' => '%s 重新命名了这个项目从 "%s" 为 "%s"。',
  ...
  '%s set this project\'s color to %s.' => '%s 设定了这个项目的色彩为 %s。',
  '%s set this project\'s icon to %s.' => '%s 设定了这个项目的图示为 %s。',
  '%s set this project\'s image to %s.' => '%s 设定了这个项目的图片为 %s。',
...
Projects which are invalid or unrecognized will be ignored. This command has no effect if you do not specify any projects.' => NULL,
  ...
  'Adjust project colors.' => '调整项目色彩。',
  'Adjust project icons.' => '调整项目图示。',
  'Advanced Filter' => '进阶筛选',
  'Advanced Filter...' => '进阶筛选...',
  'All Engineering' => NULL,
  'All Scan' => NULL,
  'Already Milestone' => NULL,
  'Ancestor Projects' => '上层项目',
  'Apply Filter' => '套用筛选',
  ...
  'Array of custom fields for Projects.' => '自订项目栏位的阵列。',
  ...
  'Browse Viewer Projects' => '浏览检视者的项目',
  'Bugs' => NULL,
  'Can Create Projects' => '可建立项目',
  'Can Lock Project Membership' => '可锁定项目成员',
  'Can Not Hide Default Column' => '不可隐藏预设栏位',
  'Change Background Color' => '更改背景色彩',
  'Change Project Tags' => '更改项目标籤',
  'Change project slugs.' => NULL,
  'Change the project icon.' => '更改项目图示。',
  'Change the project tag color.' => '更改项目标籤色彩。',
...
See [[ %s | Projects User Guide ]] in the documentation for details. This process can not be undone.' => '建立项目的第一个子项目会 **移动所有成员** 成为子项目的成员。

请参考在说明文件中的 [[ %s | 项目使用者指南 ]] 来取得详细资讯，这个程序将无法还原。',
  ...
  'Members of the parent project are members of this project.' => '父项目的成员即为此项目的成员。',
  'Members: %s' => '成员: %s',
  'Members: ...' => '成员: ...',
  ...
  'Project Points' => '项目点数',
  'Project Subprojects' => '项目子项目',
  'Project Watchers' => '项目监视者',
  'Project Workboard' => '项目看板',
  'Project colors must have unique keys, but two icons share the same key ("%s").' => '项目色彩必须有唯一键，但有两个图示使用相同的键值 ("%s")。',
  'Project colors must include one color marked as the "%s" color, but no such color exists.' => '项目色彩必须包含一个已标记为 "%s" 的色彩，但目前没有这个色彩。',
  'Project depth is too great.' => '项目深度太深。',
  'Project icon.' => '项目图示。',
  'Project icons must have unique keys, but two icons share the same key ("%s").' => '项目图示必须有唯一键，但有两个图示使用相同的键值 ("%s")。',
  'Project icons must include one icon marked as the "%s" icon, but no such icon exists.' => '项目图示必须包含一个已标记为 "%s" 的图示，但目前没有这个图示。',
  'Project icons must include one icon marked with special attribute "%s", but no such icon exists.' => '项目图示必须包含一个已使用特别属性 "%s" 标记的图示，但目前没有这个图示。',
  'Project members can take this action.' => '项目成员可做此动作。',
  'Project membership changes.' => '项目成员变更。',
  'Project name generates the same hashtag ("%s") as another existing project. Choose a unique name.' => '项目名称所产生的 Hashtag ("%s") 与其他既有项目相同，请挑选一个独一无二的名称。',
  'Project name is required.' => '项目名称为必填。',
  'Project name, hashtags, icon, image, or color changes.' => '项目名称、Hashtag、图示、图片或色彩变更。',
  'Project name.' => '项目名称。',
  'Project names must contain at least one letter or number.' => '项目名称至少要有一个字元或数字。',
  'Project tag color.' => '项目标籤色彩。',
  'Project watcher list changes.' => '项目监视员清单变更。',
  'Projects' => '项目',
  'Projects User Guide' => '项目使用指南',
  'Projects are flexible storage containers used as tags, teams, projects, or anything you need to group.' => '项目是一个很有弹性的储存容器，可以用在标籤、团队、项目或任何您需要编组的东西。',
  'Projects being edited' => '项目被编辑中',
  'Projects, Tags, and Teams' => '项目、标籤与团队',
  'Projects: ...' => '项目: ...',
  'Quick Create' => '快速建立',
  'React to projects being created or updated.' => '项目建立或更新时触发。',
  'Read information about projects.' => NULL,
  'Read information about workboard columns.' => NULL,
  'Really activate project?' => '确定要启用项目?',
  'Really archive project?' => '确定要封存项目?',
  'Reef' => NULL,
...
%s' => NULL,
  ...
  'This project has milestones.' => '此项目已有里程碑。',
  'This project has subprojects.' => '此项目已有子项目。',
  ...
  'This project will be moved to the archive.' => '这个项目将会被封存。',
  ...
  'Type a user or project name...' => '请输入使用者或项目名称',
  ...
  'Use Parent Background (Default)' => '使用父项目背景 (预设)',
  ...
  'Watchers' => '监视者',
  'Watching' => '监视中',
  'Watching Ancestor' => '监视上层项目中',
  'Watching a project also watches all subprojects and milestones of that project.' => '监视项目也会同时监视该项目底下所有的子项目与里程碑。',
  'Watching a project will let you monitor it closely. You will receive email and notifications about changes to every object tagged with projects you watch.' => '监视项目可让您更密切监控该项目的活动，您将会收到每个有标记此项目的物件有关变更的邮件与通知。',
  ...
  'When mail is sent to members of this project, you will no longer receive a copy.' => '当有邮件寄送给此项目的成员时，您将不再会收到複本。',
  'When mail is sent to members of this project, you will receive a copy.' => '当有邮件寄送给此项目的成员时，您会收到一份複本。',
  'When mail is sent to project members, you will not receive a copy.' => '当有邮件寄送给项目成员时，您将不会收到複本。',
  'Workboard' => '工作看板',
  ...
  'You will no longer receive email or notifications about every object associated with this project.' => '您将再也不会收到与此项目相关的每个物件的邮件或通知。',
  ...
  '[Project]' => '[项目]',
  'members of project' => '这个项目的成员',
  'members of projects' => '指定项目的成员',
  'project' => '项目',
...
e.g.
  ...
  '(Restricted/Invalid Project)' => '(受限制/无效的项目)',
  ...
  'Project "%s" is not a valid project which you have permission to see.' => '项目 "%s" 是您有权限查看的无效项目。',
...
Users who are CC\'d on the email itself are also automatically subscribed if Phabricator knows which accounts are linked to their email addresses.' => NULL,
  ...
  'Add users or projects as subscribers.' => '加入使用者或项目为订阅者。',
...
Note that different controls support //different// functions (depending on what the control is doing), so these specific functions may not work everywhere. You can always check the help for a control to review which functions are available for that control.' => NULL,
  ...
  'Debugging' => NULL,
  'Dec 31, 1969' => NULL,
  'Default Project Profile Image' => '预设项目基本资料图片',
